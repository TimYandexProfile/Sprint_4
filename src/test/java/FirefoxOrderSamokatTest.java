...
public class FirefoxOrderSamokatTest {
    ...
    @Before
    public void setUp() {
        System.setProperty(Constants.FIREFOX_DRIVER_PROP, Constants.FIREFOX_DRIVER_LOCATION);
    ...
    public void runTest() {
        ...
        Assert.assertEquals("Заказ успешно оформлен!", response);
    }
